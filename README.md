# Project Outline
This project was submitted as part of the Object-Oriented Java Programming module at The Open University. It introduces fundamental object-oriented concepts by modelling the behaviour of a hotel room safe, including its internal state, user interactions, and stored contents.
...
### Safe
* Stores the hotel guest's items 
...
* Tracks the `Safe` display messages
...
To make the project easier to explore outside the university environment, I added a small Main.java class to demonstrate the core functionality. The demonstration is intended to showcase the design of the classes rather than every aspect of the original assignment.
